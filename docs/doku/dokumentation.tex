...
\renewcommand{\lstlistingname}{Quellcode} % Ändern des Präfixes in den Captions
\renewcommand{\lstlistlistingname}{Quellcodeverzeichnis} % Ändern des Namens für das Listing-Verzeichnis
